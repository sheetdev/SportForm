...
<div>
<form   style="padding: 20px; margin: 10px; font-size: 20px; ">
...
<input type="email" name="email" placeholder="sheet123@gmail.com"><br><br>


<label>Mobile No:</label><br>
<input type="tel" name="mnumber" placeholder="9727858926" maxlength="10" ><br><br>


Gender:<input type="radio" name="male">Male<input type="radio" name="male">Female<input type="radio" name="male">Other<br><br>
...
Skill:<input type="range" name="skill" max="100" min="20"><br><br>

<label>Adhar card upload:</label>
<input type="file" name="adhar" accept="image/*"><br><br>
Field: <textarea rows="2" cols="8" placeholder="enter your favorites place in your game..."></textarea><br><br>
<input type="checkbox" name="per">Do you have a kit or not?(if yes then check)<br><br>
